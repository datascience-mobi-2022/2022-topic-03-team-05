...
for (i in colRep1ctrl){
  barplot(rep_sum[i:(i+2)], main = "protein amount per Ctrl replicate before normalization", cex.names = .7)}

## RNase sum fraction-wise before normalization
for (i in colRep1rnase){
  barplot(rep_sum[i:(i+2)], main = "protein amount per RNase replicate before normalization", cex.names = .7)}
...
for (i in colRep1ctrl){
  barplot(rep_sum_norm[i:(i+2)], main = "protein amount per Ctrl replicate after normalization", cex.names = .7)}

## RNase sum fraction-wise before normalization and visualize protein amount
for (i in colRep1rnase){
  barplot(rep_sum_norm[i:(i+2)], main = "protein amount per RNase replicate after normalization", cex.names = .7)
}
