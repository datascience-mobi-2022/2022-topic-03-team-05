...
```{r}
FullDat <- read.table("C:/Dokumente/Uni/FS 4/Data Analysis/RDeeP_HeLa_Mitosis.csv", header = TRUE, row.names=1, sep = ";") 
...
```{r}
which(rowSums(is.na(TripCtrldat))==75),] ##ist 0
which(rowSums(is.na(TripRnasedat))==75),] ##ist 0
...
table(km.clusters1, proteins_global_shift$global_max_rnase) ## cluster 4 first ten fractions, cluster 1 middle fractions
table(km.clusters1, proteins_global_shift$global_max_ctrl) ## cluster 1 last ten fractions, cluster 4 last ten fractions
