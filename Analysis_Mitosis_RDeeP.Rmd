...
sum(mabs_max$sign) ## how many proteins have a significant shift in protein amount in their global maximum (xxxxx out of xxxxxx)
...
dim(mproteins_local_shift) ## xxxxxxx proteins shift in local maximum
...
dim(mproteins_both_shift) ## xxxxxx proteins shift in both global and local maximum
mproteins_shifting = merge(mproteins_global_shift, mproteins_local_shift, by = "protein", all = TRUE) ## xxxxxx proteins have a shift in either local and/or global maximum
