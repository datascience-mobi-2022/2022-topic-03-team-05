...
![Figure 2: Protein amount in fractions 1:25 in all three replicates before normalization. The three replicates can now be compared better, as the amount of protein in each replicate is set to the same value.](Images/Figure2 proteins normalized.JPG){#id .class width=50% height=50%}
...
<center>![Figure 6: k-means clustering. The shift of the global maximum of the proteins during interphase was clustered against the shift during mitosis to compare the RNA interactome between the cell cycle phases.](Images/k-means clustering plot){#id .class width=50% height=50%}<center>
