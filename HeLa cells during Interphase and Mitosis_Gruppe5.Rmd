...
After the analysis of the Interphase dataset we implemented the same method for the Mitosis dataset. All steps were were performed the same way. In the Mitosis dataset we were able to identify 1828 proteins which either showed an x-shift in the global and or local maxima, 1045 proteins with a full shift and 913 proteins with a partial shift. After statistical testing, in regards to the y-shifts 1244 proteins, which had a significant shift in the global and or local maxima remained. </div> 
