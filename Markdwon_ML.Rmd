...
vgl = cbind(vgl, truesum)
return(vgl[,26])
}

compare_max(maxctrl_3, maxctrl3_3)
...
rows_rep = vgl[,26]
compare_max(a,c)
rows_rep = cbind(rows_rep, vgl[,26])
compare_max(b,c)
rows_rep = cbind(rows_rep, vgl[,26])
return(rows_rep)

#for schleife und alle rownames ausgeben, wo ganze zeile (oder mindestens 2?) ungleich 0
}

comp_rep(maxctrl1_3, maxctrl2_3, maxctrl3_3)
# rownames mit rownames(vgl)[which(vgl[,26]>0)]
