...
dim(proteins_both_shift) ## 687 proteins y-shift in both global and local maximum
proteins_shifting = merge(proteins_global_shift, proteins_local_shift, by = "protein", all = TRUE) ## 1653 proteins have a y-shift in either local and/or global maximum
...
nrow(proteins_only_global) ## 182 proteins only y-shift in global maximum
proteins_only_local = anti_join(proteins_local_shift, proteins_both_shift, by = "protein") 
nrow(proteins_only_local) ## 784 proteins only y-shift in local maximum
